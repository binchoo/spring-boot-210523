...
public class PostsApiControllerTest {
    ...
    public void BaseTimeEntity_등록() {
        LocalDateTime now = LocalDateTime.of(2021, 5, 30, 11, 00, 11);
        ...
        System.out.println(">>>>> Created Date:" + posts.getCreatedDate() + " LastModifiedDate:" + posts.getModifiedDate());
